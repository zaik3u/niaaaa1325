...
void menu_principal() {
    ...
    do {
        ...
        gotoxy(21, 9);printf("1. Registrar Articulos");
        gotoxy(21, 10);printf("2. Registrar Ventas");
        gotoxy(21, 11);printf("3. Registrar Compras");
        gotoxy(21, 12);printf("4. Registrar Clientes");
        gotoxy(21, 13);printf("5. Imprimir Articulos");
        gotoxy(21, 14);printf("6. Imprimir Ventas");
        gotoxy(21, 15);printf("7. Imprimir Compras");
        gotoxy(21, 16);printf("8. Imprimir Clientes");
        gotoxy(21, 17);printf("9. Configurar Colores");
        gotoxy(20, 18);printf("10. Imprimir creditos");
        gotoxy(21, 8);printf("0. Salir");
        
        gotoxy(20, 20);printf("Seleccione una opcion (0-10): ");
        ...
        switch(opcion) {
            ...
            case 0: 
                gotoxy(20, 20);printf("                               ");
                gotoxy(20,20);printf("Adios brou!");
                getch();
                break;
            default:
                gotoxy(20, 20);
...
void registrar_articulos() {
    ...
    do {
        ...
        gotoxy(28, 7);printf("REGISTRAR ARTICULOS");
        ...
        gotoxy(20, 15);printf("Articulo registrado exitosamente!");
...
void imprimir_creditos(){
	...
	gotoxy(15,8);printf("Integrantes del equipo:");
	gotoxy(15,12);printf("Penuelas Esquer Ana:  Codificacion y arreglo de estructuras");
	gotoxy(15,13);printf("Lopez Fernandez Romina:   Estructuracion del codigo y estilo");
	getch();
	clrscr();
...
void dibujarEstrella() {
    clrscr();
    gotoxy(22,5);printf("Die Rose 			Maquillaje");
    gotoxy(22,19);printf("Vor Romina          &          Esquer");
    int centroX = 40; //Horizontal Comienza de aqui para q no de problemaz
    int centroY = 12;//Altura
    ...
    gotoxy(centroX - 2, centroY - 4);
    printf("*");
    gotoxy(centroX + 2, centroY - 4);
    printf("*");
    
    gotoxy(centroX - 4, centroY - 3);
    printf("*");
    gotoxy(centroX + 4, centroY - 3);
    printf("*");
    
    gotoxy(centroX - 6, centroY - 2);
    printf("*");
    gotoxy(centroX + 6, centroY - 2);
    printf("*");
    
    for(int i = -5; i <= 5; i++) {
        gotoxy(centroX + i, centroY - 1);
        printf("*");
    }
    
    for(int i = -3; i <= 3; i++) {
        gotoxy(centroX + i, centroY);
        printf("*");
    }
    
    gotoxy(centroX - 4, centroY + 1);
    printf("*");
    gotoxy(centroX + 4, centroY + 1);
    printf("*");
    
    gotoxy(centroX - 3, centroY + 2);
    printf("*");
    gotoxy(centroX + 3, centroY + 2);
    printf("*");
    
    gotoxy(centroX - 2, centroY + 3);
    printf("*");
    gotoxy(centroX + 2, centroY + 3);
    printf("*");
    
    gotoxy(centroX - 1, centroY + 4);
    printf("*");
    gotoxy(centroX + 1, centroY + 4);
    printf("*");
